...
<template>
  <div class="relative rounded-full white-06 overflow-hidden">
    <input :type="inputProps.type" :required="required" v-model="modelValueProxy" :placeholder="placeholder" class="w-full py-3 px-5 text-white border border-[#646464] rounded-full focus:border-[#BBFF00] focus:outline-hidden" :class="isError !== '' ? '!border-[#FF4561]' : ''" @keydown.enter="emit('keydown-enter')" />
